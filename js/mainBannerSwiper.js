const bannerImgs = [
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main01",
    imgMobile: "./assets/images/webp/slide-banner/slide_main01_m",
    color: "#d3e3df",
    alt: "주말마다 만나요! 타이어픽 만포인트 참여 시 100% 드려요",
  },
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main02",
    imgMobile: "./assets/images/webp/slide-banner/slide_main02_m",
    color: "#ecf2fb",
    alt: "삼공사공 여성의 픽 인기 타이어 탑 텐 최대 53% 할인",
  },
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main03",
    imgMobile: "./assets/images/webp/slide-banner/slide_main03_m",
    color: "#2b5cd2",
    alt: "와이퍼도 타이어픽 전 상품 무료배송 최대 74% 할인",
  },
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main04",
    imgMobile: "./assets/images/webp/slide-banner/slide_main04_m",
    color: "#6f49fa",
    alt: "구매리뷰 쓰고 만사천 포인트 받자! 타이어픽 리뷰 이벤트",
  },
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main05",
    imgMobile: "./assets/images/webp/slide-banner/slide_main05_m",
    color: "#21273c",
    alt: "신규회원 3천원 할인 앱 설치하면 4천원 더",
  },
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main06",
    imgMobile: "./assets/images/webp/slide-banner/slide_main06_m",
    color: "#070707",
    alt: "나도 친구도 만원씩 사이좋게 혜택받자 친구초대 이벤트",
  },
  {
    imgWeb: "./assets/images/webp/slide-banner/slide_main07",
    imgMobile: "./assets/images/webp/slide-banner/slide_main07_m",
    color: "#3264d3",
